...
def read_config():
    try:
        ...
        return {
                    ...
                    'channel_url': default_conf['channel_url'] if 'channel_url' in default_conf else 'https://raw.gitmirror.com/ltdrdata/ComfyUI-Manager/main',
        ...
        return {
            ...
            'badge_mode': 'none',
            'git_exe': '',
            'channel_url': 'https://raw.gitmirror.com/ltdrdata/ComfyUI-Manager/main',
            'share_option': 'all',
            'bypass_ssl': False,
            'file_logging': True,
            'default_ui': 'none',
